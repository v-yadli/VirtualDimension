...
!include "LogicLib.nsh"
  ...
  OutFile "VirtualDimension-SSE2-Setup.exe"
...
Section "MainSection" SEC01
  ...
  ${If} ${RunningX64}
    File "LICENSE.html"
    File "x64\Release_SSE2\HookDLL.dll"
    File "x64\Release_SSE2\langEN.dll"
    File "x64\Release_SSE2\langFR.dll"
    File "x64\Release_SSE2\langJP.dll"
    File "x64\Release_SSE2\VirtualDimension.exe"
  ${Else}
    File "LICENSE.html"
    File "Release_SSE2\HookDLL.dll"
    File "Release_SSE2\langEN.dll"
    File "Release_SSE2\langFR.dll"
    File "Release_SSE2\langJP.dll"
    File "Release_SSE2\VirtualDimension.exe"
  ${EndIf}
