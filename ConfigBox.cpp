...
extern TCHAR desk_name[80];
extern TCHAR desk_wallpaper[256];
   ...
   if (level == TRANSPARENCY_DISABLED)
	{
		...
		_stprintf_s(buffer, 15, TEXT("%3i (%s)"), level, disabled);
	}
   else
	   _stprintf_s(buffer, 15, TEXT("%3i"), level);
