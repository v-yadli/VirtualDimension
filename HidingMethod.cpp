...
void HidingMethod::SetWindowData(Window * wnd, DWORD data)
{
   wnd->m_hidingMethodData = data;
}

DWORD HidingMethod::GetWindowData(const Window * wnd)
{
...
void HidingMethodMove::Show(Window * wnd)
{
   ...
   SetWindowLongPtr(*wnd, GWL_EXSTYLE, GetWindowData(wnd));  
